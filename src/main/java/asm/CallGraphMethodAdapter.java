...
public class CallGraphMethodAdapter extends JvmMethodAdapter<String> {
    ...
    public CallGraphMethodAdapter(Map<ClassReference.Handle, ClassReference> classMap,
                                  ...
                                  Map<MethodReference.Handle, Set<Integer>> passthroughDataflow, final int api, Set<CallGraph> discoveredCalls,
